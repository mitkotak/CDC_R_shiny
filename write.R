...
data <- 
  read_table("Insecticide  Insecticide_Concentration  Ae.aegypti_Diag_time(min)  Ae._albopictus_Diag_time(min)  Cx.pipiens_Diag_time(min)  Cx.quinquefasciatus_Diag_time(min)  Cx.tarsalis_Diag_time(min)
...
write_csv(data, 'insecticide_diag_time.csv')